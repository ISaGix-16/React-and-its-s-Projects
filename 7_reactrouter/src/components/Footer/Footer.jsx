      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <p className="mt-4 text-gray-500 max-w-xs text-sm leading-6">
              Building modern digital experiences with clean design,
              thoughtful development and technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a
                  href="https://github.com/ISaGix-16"
                  className="transition-colors duration-200 hover:text-orange-500"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span className="text-sm text-gray-500">
            ...
            <a
              href="https://amanarya.com/"
              className="font-medium text-gray-400 transition-colors duration-200 hover:text-orange-500"
            >
              amanarya
            </a>
